...
$logout = "logout.php";
$result=mysqli_query($con,"DELETE FROM cart WHERE User_id='$uname'");
}
}
?>
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="success-page">
                <img  src="sucess.png" class="center" alt="" />
                <h2>Payment Successful !</h2>
                <p style="color: white">We are delighted to inform you that we have received your payment of Rs <?php echo $cost?>  </p>
