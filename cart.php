...
//if connected then Select Database.
    ...
    if (isset($_GET['email']) && isset($_GET['uname'])) {
       ...
       // $result = $con->query("SELECT  `Pro_id`, `Pro_name`, `Price`, `Pro_qty` FROM `cart` WHERE User_id='$uname')");
        $result=mysqli_query($con,"SELECT  transaction_id,Pro_id,Pro_name,Price,Pro_qty FROM cart WHERE User_id='$uname'");
                    ...
                    <table class="table  table-bordered">
                        <tbody style="color:black;">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $sum=$sum+$row['Pro_qty']*$row['Price'];
                                
                                echo "<td><a href='$x'>Delete</a></td>";
                               
                                echo "</tr>";
                            }
                            $checkout=$checkout."&cost=".$sum;
                            ?>
                        ...
                        <tr id="row5">
                            ...
                            <th><a href= "<?php echo $checkout?> "><input type="submit" value="confirm order" class="btn btn-primary"></a></th>
                        </tr>
                    </tbody>
